...
export const PlayIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className || 'h-5 w-5'} viewBox="0 0 24 24" fill="currentColor">
    <path d="M6.343,21.229c-0.345-0.125-0.62-0.355-0.803-0.662c-0.183-0.306-0.27-0.655-0.27-1.02V4.453c0-0.365,0.087-0.714,0.27-1.02c0.183-0.307,0.458-0.537,0.803-0.662C6.838,2.618,7.39,2.67,7.86,2.9L21.053,9.9c0.41,0.191,0.73,0.5,0.926,0.882c0.198,0.383,0.297,0.809,0.297,1.241s-0.1,0.858-0.297,1.241c-0.197,0.382-0.516,0.691-0.926,0.882L7.86,21.1c-0.47,0.23-1.022,0.282-1.517,0.129Z"/>
  </svg>
);
...
export const MagicWandIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.25278V2.25278M12 21.7528V17.7528M17.7528 12H21.7528M2.25278 12H6.25278M15.5523 8.44772L18.3807 5.61929M5.61929 18.3807L8.44772 15.5523M15.5523 15.5523L18.3807 18.3807M5.61929 5.61929L8.44772 8.44772M12 15.7528C14.0711 15.7528 15.7528 14.0711 15.7528 12C15.7528 9.92893 14.0711 8.25278 12 8.25278C9.92893 8.25278 8.25278 9.92893 8.25278 12C8.25278 14.0711 9.92893 15.7528 12 15.7528Z" />
  </svg>
);
...
export const RedoIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13 15l3-3m0 0l-3-3m3 3H5a5 5 0 015-5V5" />
    </svg>
);
...
export const AdjustmentsIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 16v-2m-6-6H4m16 0h-2m-6 8a4 4 0 100-8 4 4 0 000 8zM4 12a8 8 0 1116 0 8 8 0 01-16 0z" />
    </svg>
);

export const BackgroundEraserIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M20.29 20.29L3.71 3.71"/>
        <path d="M9.21 9.21a5.66 5.66 0 000 7.07 5.66 5.66 0 007.07 0"/>
        <path d="M14.79 14.79a5.66 5.66 0 000-7.07 5.66 5.66 0 00-7.07 0"/>
        <path d="M13.5 6.5l-3-3"/>
        <path d="M6.5 13.5l-3-3"/>
        <path d="M17.5 10.5l3 3"/>
        <path d="M10.5 17.5l3 3"/>
    </svg>
);

export const ColorSplashIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z"/>
    </svg>
);

export const StyleTransferIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BrushIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9.06 4.31L4.31 9.06c-1.17 1.17-1.17 3.07 0 4.24l8.49 8.49c1.17 1.17 3.07 1.17 4.24 0l4.75-4.75c1.17-1.17 1.17-3.07 0-4.24L13.3 4.31c-1.17-1.17-3.07-1.17-4.24 0z" />
    <path d="M15 8l-4 4" />
  </svg>
);
...
export const DevicePreviewIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="13" y="8" width="8" height="12" rx="1" ry="1"></rect>
        <path d="M18 12h.01"></path>
        <path d="M3 6a2 2 0 012-2h11a2 2 0 012 2v3"></path>
        <path d="M3 10v1a2 2 0 002 2h2"></path>
    </svg>
);

export const VideoIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M22 5.52H2a.5.5 0 00-.5.5v12a.5.5 0 00.5.5h20a.5.5 0 00.5-.5v-12a.5.5 0 00-.5-.5zM8 12l6-3-6-3v6z"/>
    </svg>
);
...
export const MailIcon: React.FC<{ className?: string }> = ({ className = 'h-8 w-8 text-indigo-400' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
);

export const SupportIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8 text-indigo-400" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const RocketIcon: React.FC<{ className?: string }> = ({ className = "h-5 w-5" }) => (
...
export const TelegramIcon: React.FC<{ className?: string }> = ({ className = 'h-6 w-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.09.032.193.03.294a.8.8 0 0 1-.03.284c-.073.25-.196.488-.344.714l-2.01 9.27c-.19.863-.574 1.14-1.08 1.132-.999-.015-1.571-.375-2.288-1.09-1.045-1.04-1.636-1.624-2.652-2.633-.314-.306-.62-.607-.923-.906-.29-.288-.618-.54-.618-.91v-.008c.002-.28.182-.44.618-.576.966-.308 2.308-1.012 2.308-1.012s.31-.205-.128-.512c-.438-.308-1.543.83-1.543.83s-.08.05-.17.08c-.09.03-.21.03-.26.03-.28 0-.85-.16-1.38-.35-.71-.25-1.19-.38-1.12-.82.04-.32.48-.64.96-.98 2.16-1.52 4.33-3.04 6.49-4.56.34-.24.58-.38.91-.38.16 0 .32.04.47.12z"/>
    </svg>
);
...
export const TikTokIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
        <path d="M16.6,5.82H19.55V16.24C19.55,18.33 17.85,20 15.75,20C13.65,20 11.95,18.33 11.95,16.24V0H15.11V13.06C15.11,14.18 15.93,15.06 17.05,15.06C18.17,15.06 19.55,14.18 19.55,13.06V9.67H16.6V5.82M12.8,5.54C12.8,8.24 10.74,10.42 8.17,10.42C5.6,10.42 3.54,8.24 3.54,5.54C3.54,2.84 5.6,0.58 8.17,0.58C10.74,0.58 12.8,2.84 12.8,5.54Z" />
    </svg>
);

// --- New Icons for UI Updates ---
