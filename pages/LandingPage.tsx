...
const LandingPage: React.FC = () => {
  const heroSpec: HeroSpec = {
    ...
    subtitle:
      "Unleash your creativity with Clip-Yube. Transform images, generate videos, and craft viral content with our powerfully simple AI-driven suite.",
    cta: {
      label: "Start Creating Now",
      // If this is Next.js, use proper routing:
      href: "/editor",
    },
  };
